...
int main(int argc, char* argv[]) {
    ...
    Mix_Music *SelectMusic = Mix_LoadMUS("./MenuSelect.wav");
    //Mix_PlayMusic(SelectMusic, -1); //old music starting point
    ...
    SDL_Rect rect4 = { 100, 340, 400, 100 };
    ...
    while (!quit)
    {
        ...
        case SDL_KEYDOWN:
            ...
            case SDLK_UP:
                //move cursor up
                cursor.y -= 100;
                played = Mix_PlayMusic(SelectMusic, 0);//Plays select sound--------------------test
                if (played = -1){
                    std::cout << "error";
                }
            ...
            case SDLK_DOWN:
                //move cursor down
                cursor.y += 100;
                Mix_PlayMusic(SelectMusic, 0);//Plays select sound
