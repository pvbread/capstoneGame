...
//load a font, display a list of options, and allow the move a cursor around the list
...
int main()
{
    ...
    SDL_SetRenderDrawColor(renderer, 0, 100, 255, 50);
    ...
    SDL_Rect rectToDraw = {45,150,460,305};
