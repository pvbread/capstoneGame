...
int main(int argc, char* argv[]) {
    ...
    SDL_Color pressColor = { 0, 200, 200, 255};
    // create 4 surfaces, one for each option
    ...
    // create 4 textures, one for each option
    ...
    while (!quit)
    {
        ...
        case SDL_MOUSEMOTION: {
            ...
            {
                SDL_Log("Mouse Button 1 (left) is pressed."); //Will tell when mouse is being clicked when mouse moving
            }
            break;
        }
