...
void DashDaCapo::runGameLoop()
{
    ...
    */
    ...
    TextBox t3 = TextBox("What a horrible", 60, 0, 0, 300, 100, Font::inter, Color::white, Color::blue, true);
    TextBox t4 = TextBox("night to have a curse", 60, 0, 350, 300, 100, Font::inter, Color::white, Color::blue, true);
            ...
            if (event.type == SDL_KEYDOWN)
            {
                switch (event.key.keysym.sym)
                {
                    ...
                    case SDLK_5:
                    {
                        ...
                        t3.setTransparency(255);
                        t4.setTransparency(255);
                        break;
                    }
                    case SDLK_6:
                    {
                        ...
                        STATE_transparent = true;
                        t3.setTransparency(80);
                        t4.setTransparency(80);
                        break;
                    }
                    case SDLK_7:
                    {
        ...
        switch (screen)
        {
            case INTRO:
            {
                ...
                else
                {
                    ...
                    t3.render(getRenderer());
                    t4.render(getRenderer()); 
                }
